...
public class WikipediaUtilsTest {
	...
	public void testGetNextPageSimple() {
		...
		assertEquals("Success", WikipediaPageUtils.getNextPage(nextPageShouldBeSuccess));
	}
	...
	@Test
	public void testGetNextPageWithBr() {
		String nextPageShouldBeSuccess = "<br> [[Success]]";
		assertEquals("Success", WikipediaPageUtils.getNextPage(nextPageShouldBeSuccess));
	}
	...
	@Test
	public void testGetNextPageWithLinkInLink() {
		String nextPageShouldBeSuccess = "[[Fail [[Success]] Fail]]";
		assertEquals("Success", WikipediaPageUtils.getNextPage(nextPageShouldBeSuccess));
	}
	
	@Test
	public void testGetNextPageWithNestedBrackets() {
		String nextPageShouldBeSuccess = "{[[Fail1]] {{[[Fail2]]}} [[Fail3]]} [[Success]]";
		assertEquals("Success", WikipediaPageUtils.getNextPage(nextPageShouldBeSuccess));
	}
	
	@Test
	public void testMultipleClosingBracketsNonSpaced() {
		String nextPageShouldBeSuccess = "{{ {{}}}}{{{}}}{{ {}}}[[Success]]";
		assertEquals("Success", WikipediaPageUtils.getNextPage(nextPageShouldBeSuccess));
	}
