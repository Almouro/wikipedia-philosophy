...
/*	private static String[] WIKIPEDIA_NAMESPACE_PREFIX = new String[] {"Talk", "User", "Wikipedia", "MediaWiki", "Template", 
		"Help", "Category", "Portal", "Book", "Draft", "Education Program", "TimedText", "Module", "Topic"};*/
	 ...
	 * 1. Ignore # links
	 * 
	 * 2. The MediaWiki software is configured so that a page title (as stored in the database) 
	 * cannot begin with a lower-case letter, and links that begin with a lower-case letter 
	 * are treated as if capitalized, i.e. [[foo]] is treated the same as [[Foo]].
	*/
