 ...
 * wrapped in a root tag specified in the config
 * 
 * Document example:
 *  <property>
 *      property 1
 ...
 *  xmlinput.start: '<property>'
 *  xmlinput.end: '</property>'
 *  xmlinput.rootstart: '<properties>'
 *  xmlinput.rootstart: '</properties>'
 *  
 *  If the first input split stops after the line 'input split',
 *  then the first mapper will receive as value:
 *  
 *  Mapper1:
 *  <properties>
 *      <property>
...
public class XmlInputFormat extends TextInputFormat {
    ...
    public static class XmlRecordReader extends RecordReader<LongWritable, Text> {
        ...
        public void initialize(InputSplit is, TaskAttemptContext tac) throws IOException,
            ...
            startRootTag = tac.getConfiguration().get(START_ROOT_TAG_KEY).getBytes("utf-8");
            endRootTag = tac.getConfiguration().get(END_ROOT_TAG_KEY).getBytes("utf-8");
